...
const string strMessageMagic = "BashCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight <= 0) {
        ...
        nSubsidy = 180000 * COIN; // premine to be confirmed
    }
    else if (nHeight <= 600) {
        nSubsidy = 1 * COIN; // premine to be confirmed
    }
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    else if (heigth <= 129600)  {
        nSubsidy = 8 * COIN;
    }
    else if (heigth <= 259200)  {
        nSubsidy = 7 * COIN;
    }
    else if (heigth <= 388800)  {
        nSubsidy = 6 * COIN;
    }
    else{
        nSubsidy = 5 * COIN;
