...
int nAnonymizeBashCoinAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\BashCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\BashCoin
    // Mac: ~/Library/Application Support/BashCoin
    // Unix: ~/.BashCoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BashCoin";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "BashCoin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "BashCoind.pid"));
